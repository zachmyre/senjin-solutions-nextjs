    ...
    <nav className="p-3 bg-gray-900 w-100">
      ...
      {showMenu && 
        <div className="text-white lg:hidden">
          ...
          {routes.map((route, i) => (
            <a key={i} className="text-lg font-bold text-gradient-to-r from-cyan-400 via-cyan-500 rounded-full to-cyan-600 shadow-cyan-500/50 shadow-lg shadow-cyan-800/80" href={route.path}>
