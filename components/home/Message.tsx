        ...
        <div className="flex items-center justify-between">
          <div className="w-2/3 flex flex-col space-y-4">
            ...
            <div className="rounded-md">
              <button
                type="button"
                className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-700 shadow-lg shadow-cyan-500/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
              >
                Learn More
              </button>
            </div>
          ...
          <div className="w-36 h-36 mr-2 md:mt-12 md:mr-12 md:w-60 md:h-60 transition ease-in-out delay-150 fill-cyan-300 hover:-translate-y-1 hover:scale-110 duration-300 shadow-xl shadow-white rounded-full">
            <svg
              ...
              viewBox="0 0 1113.000000 1280.000000"
            ...
            >
              ...
              <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)">
                <path
                  d="M11093 12776 c-4 -8 -136 -88 -293 -179 -2411 -1393 -3987 -2700
...
-675 504 -407 850 71 92 204 172 327 196 59 11 196 -3 264 -27z"
                />
                <path
                  d="M8635 9445 c-97 -86 -207 -132 -340 -141 -134 -10 -256 24 -371 102
...
181 37 111 55 195 154 227 271 6 20 10 37 9 37 -1 -1 -24 -21 -52 -45z"
                />
                <path
                  d="M4655 5469 c-91 -48 -224 -178 -497 -486 -500 -563 -1106 -1287
...
122 4 143 -21 22 -52 20 -99 -5z"
                />
                <path
                  d="M1873 2792 c-329 -249 -819 -727 -1105 -1075 -369 -452 -642 -969
...
144 170 41 50 142 159 224 243 82 83 145 152 140 152 -5 -1 -55 -36 -111 -78z"
                />
                <path
                  d="M2015 2678 c-147 -118 -412 -379 -536 -529 -246 -294 -417 -649 -430
